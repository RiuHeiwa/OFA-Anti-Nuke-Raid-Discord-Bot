/**
 * OFA Anti Raid
 * https://github.com/Riu Heiwa
 * Discord: RiuHeiwa#0001
 */
...
console.log(magenta(`
                               ...
                               Anti Raid | ElainaTeam & Folody Team | Author: Riu Heiwa
`));
...
client.on("guildBanAdd", async (guild, user) => {
    ...
    if (!banLog) {
        return console.log(red(`[Fetch Log Error]: This Log Type: 'MEM_BAN_ADD' has not been previously seen before while the 'guildBanAdd' event has been trigerred.`));
    } else {
